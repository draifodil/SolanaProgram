// src/lib.rs
/*
 * Core library for SolanaProgram
 */
...
#[derive(Debug)]
pub struct SolanaProgramProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SolanaProgramProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SolanaProgram processing");
    
    let mut processor = SolanaProgramProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SolanaProgramProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SolanaProgramProcessor::new(false);
